...
def execute_cmd(cmd):
    if cmd == 'ctime':
        ...
        # Radioni yoqish
        os.system("D:\\Music\\bodiev_karavan_8")

    elif cmd == 'stupid1':
        # Yemagan xazil
        speak(result.json()["joke"]+"kHaaa kha khaaaa khaaa")
...
speak("Salom Sherzodbek mening ismim jarvis")
speak("sizga qanday yordam bera olaman")
